    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.sertice.sandbox.amazon.advertising.jaxws.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.sertice.sandbox.amazon.advertising.jaxws.AWSECommerceService.class.getResource(".");
